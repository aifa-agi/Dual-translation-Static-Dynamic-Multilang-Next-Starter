// @/app/[lang]/@rightStatic/(_PRICE_LIST)/(_subfractals)/(_PRICE_LIST_SUBDOMAIN)/(_client)/(_uiclientislands)/fractal-price-list-subdomain-dev-label-handler.tsx
...
import type { PriceListSubdomainPageData } from "../../(_shared)/(_types)/fractal-price-list-subdomain-types";

interface FractalPriceListSubdomainDevLabelHandlerProps {
  pageData: PriceListSubdomainPageData;
  level: number;
}

export function FractalPriceListSubdomainDevLabelHandler(
  props: FractalPriceListSubdomainDevLabelHandlerProps,
) {
